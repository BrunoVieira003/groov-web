...
>
    <div
        class="w-full sm:w-1/4 flex items-center gap-2 sm:gap-4 overflow-hidden"
    >
        <img
        ...
        <div class="w-full overflow-hidden">
            <Marquee
                ><a
                    class="colorful font-bold text-md w-fit hover:cursor-pointer hover:underline"
                    href="/playing">{$currentSong?.title}</a
                ></Marquee
            >
    ...
    <div
        class="flex flex-col w-fit px-4 sm:w-2/4 items-center gap-2 justify-center"
    >
        <div class="flex items-center justify-between w-full lg:gap-2">
            <p class="not-sm:hidden w-fit text-nowrap text-xs text-subheading">
