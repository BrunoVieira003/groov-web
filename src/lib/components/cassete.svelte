<script lang="ts">
    ...
    let {title = '', coverImageSrc = emptyImage}: PropsType = $props()
...
<div class="flex flex-col items-center justify-between pt-4 bg-neutral-medium w-full aspect-video rounded-md">
    <div class="flex flex-col items-center justify-center bg-highlight w-6/7 h-2/3 rounded-md overflow-hidden">
        <div class="h-full min-h-10 w-full flex justify-center overflow-hidden px-2 py-3">
            <img
        ...
        <div class="w-8/12 h-2/4 flex items-center justify-evenly bg-neutral-light p-2 rounded-sm">
            <div class="w-1/5 bg-neutral-dark aspect-square rounded-full relative border-4 border-highlight">
                <div class="absolute left-1/2 -translate-x-1/2 h-full w-1/10 mx-auto bg-highlight"></div>
                <div class="absolute left-1/2 -translate-x-1/2 h-full w-1/10 mx-auto bg-highlight rotate-45"></div>
                <div class="absolute left-1/2 -translate-x-1/2 h-full w-1/10 mx-auto bg-highlight rotate-90"></div>
                <div class="absolute left-1/2 -translate-x-1/2 h-full w-1/10 mx-auto bg-highlight rotate-135"></div>
